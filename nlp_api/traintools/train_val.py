...
import os
from ..utils.text_cnn import TextCNN
from ..utils import create_batch_data, create_word2vec, fileprocessing
...
def train(train_dir,val_dir,labels_file,word2vec_path,batch_size,max_steps,log_step,val_step,snapshot,out_dir):
    ...
    with tf.Graph().as_default():
        ...
        session_conf = tf.ConfigProto(allow_soft_placement = allow_soft_placement,log_device_placement = log_device_placement,gpu_options=gpu_options)
...
def main():
    ...
    word2vec_path = "D:/BaiduNetdiskDownload/THUCNews_word2Vec/THUCNews_word2Vec_128.model"
